...
const InicioCliente: React.FC<Props> = ({ idUsuario, darkMode }) => {
  const arreglos = [
    { id: 1, nombre: "Ramo Rosas Blancas", imagen: "https://i.pinimg.com/736x/83/9c/14/839c145e820188c71c31e3793718acee.jpg" },
    { id: 2, nombre: "Arreglo Primaveral", imagen: "https://i.pinimg.com/1200x/6c/ef/6b/6cef6bc734185d5671cd1b8b4f6f225f.jpg" },
    { id: 3, nombre: "Ramo Mixto", imagen: "https://i.pinimg.com/736x/44/2d/cb/442dcb510c32485d439a838507ffba0f.jpg" },
    { id: 4, nombre: "Flores Pasteles", imagen: "https://i.pinimg.com/736x/3c/b4/be/3cb4be6ffd33ae05c72c326418c5e0c5.jpg" },
    { id: 5, nombre: "Rosas Blancas y Hortencias Azules", imagen: "https://i.pinimg.com/736x/1c/2e/cb/1c2ecbd48285a15625ff393d03a2b6b0.jpg" },
  ];
  ...
  return (
    <div className={`inicio-cliente-container ${darkMode ? "oscuro" : "claro"}`}>
      ...
      <p className="subtitulo">Explora y guarda tus arreglos favoritos 🌷</p>
